...
const (
	...
	uriUdp                = "udp"
	uriTftp               = "tftp"
	uriTcpAnalytics       = "tcp-analytics"
	uriTcp                = "tcp"
	uriStream             = "stream"
	uriStatistics         = "statistics"
	uriSplitsessionserver = "splitsessionserver"
	uriSplitsessionclient = "splitsessionclient"
	uriSocks              = "socks"
	uriSmtps              = "smtps"
	uriSip                = "sip"
	uriService            = "service"
	uriServerSsl          = "server-ssl"
	uriServerLdap         = "server-ldap"
	uriSctp               = "sctp"
	uriRtsp               = "rtsp"
	...
	uriOcspStaplingParams = "ocsp-stapling-params"
	uriNtlm               = "ntlm"
	uriNetflow            = "netflow"
	uriMqtt               = "mqtt"
	uriMblb               = "mblb"
	uriIpsecalg           = "ipsecalg"
	uriIpother            = "ipother"
	uriImap               = "imap"
	uriIcap               = "icap"
	uriHttp2              = "http2"
	uriHttpRouter         = "http-router"
	uriHttpProxyConnect   = "http-proxy-connect"
	...
	uriDnsLogging         = "dns-logging"
	uriDns                = "dns"
	uriDiameter           = "diameter"
	uriDhcpv6             = "dhcpv6"
	uriDhcpv4             = "dhcpv4"
	uriConnector          = "connector"
	uriClientSsl          = "client-ssl"
	uriClientLdap         = "client-ldap"
